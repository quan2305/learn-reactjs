...
export default function Header() {
    ...
    return (
        ...
        >
            ...
            <MenuItem onClick={() => {handleLogoutClick(); handleUserClose() }}>Logout</MenuItem>
        </Menu>


        <Dialog disableBackdropClick open={open} onClose={handleClose} aria-labelledby="form-dialog-title" className={classes.dialog}>
                <DialogContent>
                    <DialogContentText>
                        {mode === MODE.REGISTER && (
                            <>
